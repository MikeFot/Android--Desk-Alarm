 ...
 */
public class DialogTimeToSnoozePickerFragment extends DialogFragment implements
        TimePickerDialog.OnTimeSetListener {

    private final String TAG = "SnoozePickerFragment";
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        mOriginalSetting = mSharedPreferences.getInt(
                getString(R.string.pref_snooze_interval_key), getResources().getInteger(R.integer.time_to_snooze));
        ...
        final TimePickerDialog dialog = new TimePickerDialog(getActivity(), this,
                hour, minute, true);

        dialog.setTitle(getActivity().getString(R.string.dialog_set_snooze_time));
    ...
    public void onTimeSet(final TimePicker view, final int hourOfDay, final int minute) {
        ...
        editor.putInt(getActivity().getString(R.string.pref_snooze_interval_key), timeToAlarm);
        editor.commit();
    }
}